...
def tipo_attack(): #TYPE ATTACK
    ...
    if opcao_escolhida == '-0':  #      --deauth      count : deauthenticate 1 or all stations (-0) 
        mac_alvo = str(input('Digite o MAC Router Destino: Exemplo: 54:B8:0A:F3:3F:C3 >>>  '))
        mac_usuario = str(input('Digite o MAC Cliente Router Destino: Exemplo: B8:5A:73:AC:60:CC >>>  '))
